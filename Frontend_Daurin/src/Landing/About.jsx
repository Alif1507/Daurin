  ...
  return (
    <main className="relative" id="about">
      ...
      <img
        ...
        className="absolute bottom-20 left-[50%] -translate-x-[50%] max-sm:w-screen max-sm:top-[35%]"
        alt=""
      />
      <div className="font-poppins relative z-30 flex flex-col justify-center items-center">
       ...
       <div className="relative w-screen flex flex-col justify-center items-center">
        <p className="max-w-[646px] text-center toggleText mx-15 max-sm:text-xs">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Possimus deserunt asperiores, temporibus delectus nobis magnam! Qui nisi et porro modi voluptas, perferendis, incidunt hic cum ad non culpa velit quidem!
